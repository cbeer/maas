...
class WorkspacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workspace" do
    assert_difference('Workspace.count') do
      post workspaces_url, params: { workspace: { content: @workspace.content, published: @workspace.published, title: @workspace.title } }
    end
  ...
  test "should update workspace" do
    patch workspace_url(@workspace), params: { workspace: { content: @workspace.content, published: @workspace.published, title: @workspace.title } }
